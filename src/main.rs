...
impl Vector2D {
    fn new(px: f64, py: f64) -> Self { Self { x: px, y: py} }
...
impl DataSet {
    fn new(dataset: Vec<Vector2D>) -> Self { return Self {data_points: dataset}}
...
impl LinearRegression {
    fn new() -> Self { return Self {coefficients: Vector2D::new(0.0, 0.0)} }
    fn get_a(&self) -> f64 { return self.coefficients.get_x(); }
    fn get_b(&self) -> f64 { return self.coefficients.get_y();}
    ...
    fn predict(&self, x: f64) -> f64 { return self.get_a() * x + self.get_b(); }
}
